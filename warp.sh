...
# 下载 WGCF
init_wgcf() {
    wget --no-check-certificate https://github.com/xxf185/warp/releases/download/v1.0/wgcf-latest-linux-$(archAffix) -O /usr/local/bin/wgcf
...
warp_traffic() {
    ...
    wget -N --no-check-certificate https://github.com/xxf185/warp/blob/main/wp-plus.py
